...
{
    public partial class createOrderLogic : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PlantSizeColorId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_BasketItems_PlantSizeColors_PlantSizeColorId",
                        column: x => x.PlantSizeColorId,
                        principalTable: "PlantSizeColors",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BasketItems_PlantSizeColorId",
                table: "BasketItems",
                column: "PlantSizeColorId");
